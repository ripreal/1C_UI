...
Процедура ЗаполнитьНаборыСвойствОбъекта(Объект, ТипСсылки, НаборыСвойств, СтандартнаяОбработка, КлючНазначения) Экспорт
	...
	Если ТипСсылки = Тип("СправочникСсылка.ОбъектыИнвестиций") Тогда
		Справочники.ВидыИнвестиций.ЗаполнитьНаборСвойствПоВидуИнвестиции(Объект, ТипСсылки, НаборыСвойств);
	КонецЕсли;
