...
Процедура ПриЧтенииНаСервере(ТекущийОбъект)
	...
	//Учет инвестиций начало
	Цвет = ОбщегоНазначенияУИ.ЦветRGB(
		ТекущийОбъект.ЦветR, ТекущийОбъект.ЦветG, ТекущийОбъект.ЦветB);
	
	//Учет инвестиций конец
...
Процедура ПередЗаписьюНаСервере(Отказ, ТекущийОбъект, ПараметрыЗаписи)
	...
	Если Цвет.Вид = ВидЦвета.Абсолютный Тогда 
		...
		ТекущийОбъект.ЦветR = Цвет.Красный;
		ТекущийОбъект.ЦветG = Цвет.Зеленый;
		ТекущийОбъект.ЦветB = Цвет.Синий;
		
	Иначе
		Отказ = Истина;
		Сообщить(НСтр("ru = 'Нельзя выбирать встроенные цвета. Нужно скорректировать вручную'"));
	КонецЕсли;
